...
const HospitalCard = ({ hospital }) => {
    ...
    return (
        <div onClick={handleCardClick} className="cursor-pointer h-[300px] rounded-lg overflow-hidden shadow-lg border-[2px]">
            <div className="relative bg-blue-400 text-white text-center h-[132px]">
                ...
                <div className="absolute bottom-0 left-1/4 transform -translate-x-1/2 translate-y-1/2 w-[100px] h-[100px] bg-white rounded-full">
                    <img src={hospital.avatar} alt="doctor-avatar" className="w-full h-full object-fit rounded-[100px]" />
                </div>
            </div>
